define({ "api": [
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/account/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/account/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/account/invite"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/account/self"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/password/change"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/confirm/:token"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/password/forgot"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/rolebindings/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/roles"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/login"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/logout"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/confirm/resend"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/auth/password/reset"
      }
    ]
  },
  {
        ...
        "body) {{ids: ObjectId[]}} Array of id(s": [
          {
            ...
            "optional": false,
            "field": "that",
            "description": "<p>needed to be accepted</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "data",
            "description": "<p>success_ids array and errors array. Errors array will contain a detailed error for why the batch update for a given ID did not work</p>"
          }
        ]
      },
      "examples": [
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/batchAccept/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/acceptEmail/:email"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/accept/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/checkin/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/email/:email"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/stats"
      }
    ]
  },
  {
      ...
      "fields": {
        "body": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "travel",
            "description": "<p>How much the hacker requires a bus for transportation</p>"
          },
          {
            "group": "body",
            "type": "String[]",
  ...
  },
  {
        ...
        "body": [
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>The new status of the hacker. &quot;Accepted&quot;, &quot;Confirmed&quot;, or &quot;Withdrawn&quot;</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/confirmation/:id"
      }
    ]
  },
  {
        ...
        "body": [
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>Status of the hacker's application (&quot;None&quot;|&quot;Applied&quot;|&quot;Accepted&quot;|&quot;Declined&quot;|&quot;Waitlisted&quot;|&quot;Confirmed&quot;|&quot;Withdrawn&quot;|&quot;Checked-in&quot;)</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/status/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/resume/:id"
      }
    ]
  },
  {
    ...
    "title": "",
    "description": "<p>Sends a hacker the day-of email, along with the HackPass QR code to view their hacker profile (for checkin purposes). Hackers must be either confirmed, or checked in.</p>",
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/email/dayOf/:id"
      }
    ]
  },
  {
    ...
    "title": "",
    "description": "<p>Sends a hacker the week-of email, along with the HackPass QR code to view their hacker profile (for checkin purposes). Hackers must be either confirmed, or checked in.</p>",
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/email/weekOf/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/sponsor/self"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/hacker/self"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/api/role/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/search/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/settings/"
      }
    ]
  },
  {
      ...
      "fields": {
        "body": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "isRemote",
            "description": "<p>Whether this hackathon is remote or not.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/sponsor/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/sponsor/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/team/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/team/leave/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/team/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/team/join/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/team/:hackerId"
      }
    ]
  },
  {
      ...
      "fields": {
        "body": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "hackerId",
            "description": "<p>ObjectID of the respective hacker</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/email/:email"
      }
    ]
  },
  {
        ...
        "param": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>a travel's unique mongoID</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/:id"
      }
    ]
  },
  {
        ...
        "body": [
          {
            ...
            "optional": true,
            "field": "offer",
            "description": "<p>Amount of money offered for travel</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/offer/:id"
      }
    ]
  },
  {
        ...
        "body": [
          {
            ...
            "optional": true,
            "field": "status",
            "description": "<p>Status of the travel's reimbursement (&quot;None&quot;|&quot;Bus&quot;|&quot;Offered&quot;|&quot;Valid&quot;|&quot;Invalid&quot;|&quot;Claimed&quot;)</p>"
          }
        ]
      }
    },
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/status/:id"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/travel/self"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/volunteer/"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "https://hackerapis-9cc2b197a740.herokuapp.com/api/volunteer/:id"
      }
    ]
  }
] });
